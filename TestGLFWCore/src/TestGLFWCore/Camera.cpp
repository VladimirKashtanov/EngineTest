...
namespace TestGLFW
{
	...
	void Camera::update_projection_matrix()
	{
		...
		{
			m_projection_matrix = glm::perspective(glm::radians(m_field_of_view), m_viewport_width / m_viewport_heigt, m_near_clip_plane, m_far_clip_plane);
		}
		else
		{
			float r = 2;
